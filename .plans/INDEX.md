...
- og:image asset (head partial has og tags, no image yet)
- Active state for subpage nav links (aria-current styling)
- agent-browser post-install: verify end-to-end on a clean machine
